...
"""Tests for kron.services.registry - ResourceRegistry."""
...
from krons.resources import Endpoint, EndpointConfig, ResourceRegistry
...
class TestResourceRegistryRegistration:
    """Test ResourceRegistry registration behavior."""
...
# =============================================================================
# ResourceRegistry Retrieval Tests
# =============================================================================


class TestResourceRegistryRetrieval:
    """Test ResourceRegistry retrieval operations."""
...
# =============================================================================
# ResourceRegistry Tag Filtering Tests
# =============================================================================


class TestResourceRegistryTagFiltering:
    """Test ResourceRegistry tag-based filtering."""
...
# =============================================================================
# ResourceRegistry Utility Methods Tests
# =============================================================================


class TestResourceRegistryUtilityMethods:
    """Test ResourceRegistry utility methods."""
