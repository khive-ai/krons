...
# =============================================================================
# Action Request/Response (for act operation)
# =============================================================================


@dataclass(slots=True)
class ActionRequest:
    """Tool/function call request from LLM output."""
...
class ActionResponse:
    ...
    function: str
    """Function/tool name that was called."""
...
class Reason(BaseModel):
    """Reasoning chain for structured output with chain-of-thought."""

    title: str | None = None
    """Brief title of the reasoning step."""
